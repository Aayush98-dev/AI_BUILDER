...
export const makeRevision = async (req: Request, res: Response) => {
    ...
    try {
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content: `Now making changes your website ...`,
                projectId
            }
        })

        // Generate webiste code
        ...
        const codeGenerationResponse = await openai.chat.completions.create({
            ...
            messages: [
                ...
                {
                    role: 'user',
                    content: `Here is the current website code: "${currentProject.current_code}" The user ant this change: "${enhancedPrompt}`
                }
            ]
        })
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content: "I've made the changes on your website! You can now preview it",
                projectId
            }
        })
...
export const rollbackToVersion = async (req: Request, res:Response) => {
    try {
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content: "I've rolled back tour website to selected version. You can now preview it.",
                projectId
            }
        })
