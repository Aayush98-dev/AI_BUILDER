...
import Projectprev, { type ProjectPreviewRef } from '../components/Projectprev'
...
const Projects = () => {
  ...
  useEffect(()=>{
    if(session?.user){
      ...
      navigate("/")
      toast("Please login too view your project")
    }
  },[session?.user])
    ...
    <div className='flex flex-col h-screen w-full bg-gray-900 text-white'>
      ...
      <div className='flex max-sm:flex-col sm:items-center gap-4 px-4 py-2 no-scrollbar'>
        ...
        <div className='flex items-center justify-end gap-3 flex-1 text-xs sm:text-sm'>
          ...
          <Link target='_blank' to={`/preview/${projectId}`} className='flex items-center gap-2 px-4 py-2 rounded sm:rounded-sm border border-gray-700 hover:border-gray-500 transition-colors'>
      ...
      <div className='flex-1 flex overflow-auto'>
        ...
        <div className='flex-1 p-2 pl-0'>
          <Projectprev ref={previewRef} project={project} isGenerating={isGenerating} device={device} />
        </div>
      </div>
