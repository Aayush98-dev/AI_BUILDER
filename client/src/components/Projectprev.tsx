...
const Projectprev = forwardRef<ProjectPreviewRef, ProjectPreviewProps>(({project, isGenerating, device = 'desktop', showEditorPanel = true}, ref) => {
    ...
    useImperativeHandle(ref, ()=>({
        getCode: ()=>{
            ...
            // Remove injected style + script from the element
