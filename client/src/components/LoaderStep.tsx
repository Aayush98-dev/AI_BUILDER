...
const LoaderStep = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white'>
        <div className='absolute inset-0 bg-linear-to-br from-blue-500/10 via-purple-500/10 to-fucksia-500/10 blue-3xl animate-pulse'></div>
        ...
        {/* Label fade using transition only ( no invisible start) */}

        <p key={current} className='mt-8 text-lg font-light text-white/90 tracking-wide transition-wide transition-all duration-700 ease-in-out opacity-100'>
            {steps[current].label}
        </p>  
